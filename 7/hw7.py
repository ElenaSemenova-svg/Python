...
def rifma(vini_chant):
    string_chant = vini_chant.lower().split()
    func = lambda x: sum(1 for i in x if i in 'аеёиоуыэюя')
    value = func(string_chant[0])
    if all([func(i) == value for i in string_chant]):
        return 'Парам пам-пам'
    return 'Пам парам'
 
print(rifma("Пара-ра-рам рам-пам-папам па-ра-па-дам"))
print(rifma("Пара-рам рам-пам-папам па-ра-па-дам"))
